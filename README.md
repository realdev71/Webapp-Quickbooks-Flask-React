...
work with their specific accounting structure, be easy to onboard new, non-technical users, be fully accessible for the accountant and finally, as a start-up, they needed it to be relatively inexpensive.
...
“Premade receipt trackers just weren’t cutting it, they were either crazy expensive, overloaded with unnecessary features, or would require way too much time to adjust to our needs” - Sam Stewart, Red Root‍
